...
public class DubboEnterpriseLicense implements Serializable{
     ...
     * 查询条件 失效时间起始
     */
    private Timestamp invalidDateStart;
    
    /**
     * 查询条件 失效时间结束
     */
    private Timestamp invalidDateEnd;
    

	public Timestamp getInvalidDateStart() {
		return invalidDateStart;
	}

	public void setInvalidDateStart(Timestamp invalidDateStart) {
		this.invalidDateStart = invalidDateStart;
	}

	public Timestamp getInvalidDateEnd() {
		return invalidDateEnd;
	}

	public void setInvalidDateEnd(Timestamp invalidDateEnd) {
