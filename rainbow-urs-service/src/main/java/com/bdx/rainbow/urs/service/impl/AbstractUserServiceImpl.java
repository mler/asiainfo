...
import com.bdx.rainbow.mapper.urs.SysUserExtMapper;
import com.bdx.rainbow.mapper.urs.SysUserMapper;
...
public abstract class AbstractUserServiceImpl implements IUserService {
	...
	public Integer insertUser(SysUser record) throws SystemException,
			BusinessException {
		record.setUserStatus(Constants.USER_STATUS_NORMAL_1);
	...
	public com.bdx.rainbow.entity.urs.SysUserModel getUserAndExtById(Integer userId)
			throws SystemException, BusinessException {
...
//		return StringUtils.equals(obj.getLoginPwd(), oldPWD);
	...
	private SysUserExample getCondition (SysUser obj) {
		...
		if (obj != null) {
            ...
            if(obj.getAdminUser() != null && StringUtils.isNotEmpty(obj.getAdminUser())) {
                cr.andAdminUserEqualTo(obj.getAdminUser());
            }
		}
		return where;
	}
	...
	private List<Integer> getDeptIds(SysUser user) {
		...
		if (StringUtils.equals(Constants.USERTYPES_PT_0, user.getUserType())) {
			return null;
		}
...
//		}
		...
		DefaultTree<com.bdx.rainbow.entity.urs.SysDeptTree> tree = null;
		...
		if (tree != null) {
			List<DefaultTree<SysDeptTree>> s = new ArrayList<DefaultTree<com.bdx.rainbow.entity.urs.SysDeptTree>>();
