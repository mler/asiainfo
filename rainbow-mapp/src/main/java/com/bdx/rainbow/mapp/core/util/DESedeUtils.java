...
public class DESedeUtils {
	...
	public static String byte2hexNew(byte[] b) {
	...
	public static void main(String[] args) throws Exception {
		...
		DESedeUtils.byte2hex(util.getBytes());
		long t2 = System.currentTimeMillis();
		DESedeUtils.byte2hexNew(util.getBytes());
		long t3 = System.currentTimeMillis();
		
		
		System.out.println("byte2hex:"+(t2-t1)+"  ,  byte2hexNew:"+(t3-t2));
