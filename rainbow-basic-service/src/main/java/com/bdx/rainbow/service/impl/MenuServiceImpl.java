...
import com.bdx.rainbow.mapper.sys.SysMenuMapper;
import com.bdx.rainbow.mapper.sys.SysPowerCommMapper;
import com.bdx.rainbow.mapper.sys.SysRole2MenuMapper;
import com.bdx.rainbow.service.IMenuService;
...
/*		if (count != 0) {
	...
	@Override
	public DefaultTree<SysMenuTree> getSysMenuTree(Map<String, Object> condition)
			throws SystemException, BusinessException {
		List<SysMenuTree> menus = sysPowerCommMapper.getMenuTree(condition);
		DefaultTree<SysMenuTree> tree = new DefaultTree<SysMenuTree>("-1", menus);
		return	tree;
		
	}
	
	@Override
	public DefaultTree<SysMenuTree> getSysMenuTree(List<SysMenuTree> menus, String nodeId)
			throws SystemException, BusinessException {
