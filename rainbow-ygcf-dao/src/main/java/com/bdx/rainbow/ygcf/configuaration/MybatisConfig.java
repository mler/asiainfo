 ...
 */
@Configuration
@MapperScan(basePackages = {"com.bdx.rainbow.mapper", "com.bdx.rainbow.ygcf.mapper", "com.bdx.rainbow.ygcf.mapper.custom"}, sqlSessionFactoryRef="ygcf_SqlSessionFactory")
public class MybatisConfig {
	...
	@Bean(name = "ygcf_SqlSessionFactory")
