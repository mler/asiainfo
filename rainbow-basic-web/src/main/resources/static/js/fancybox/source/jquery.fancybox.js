...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		defaults: {
			...
			// HTML templates
			tpl: {
				wrap     : '<div id="fancybox-wrap" class="fancybox-wrap" tabIndex="-1"><div class="fancybox-skin"><div id="fancybox-outer" class="fancybox-outer"><div id="fancybox-content" class="fancybox-inner"></div></div></div></div>',
